...
export class CreateHotelandRoomEntity1630611942524 implements MigrationInterface {
    name = "CreateHotelandRoomEntity1630611942524"

    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query("CREATE TABLE \"rooms\" (\"id\" SERIAL NOT NULL, \"number\" character varying NOT NULL, \"roomVacancies\" integer NOT NULL, \"ocuppiedVancies\" integer NOT NULL, \"hotelId\" integer, CONSTRAINT \"PK_0368a2d7c215f2d0458a54933f2\" PRIMARY KEY (\"id\"))");
